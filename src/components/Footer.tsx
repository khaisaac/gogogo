      ...
      <div className={`container ${styles.grid}`}>
        <div className={styles.col}>
          ...
          <div className={styles.socials}>
            <a href="https://www.instagram.com/trekking_mountrinjani/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className={styles.socialLink}>
            ...
            <a href="https://www.facebook.com/lombok.smile.9" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className={styles.socialLink}>
