...
export default function CheckoutClient({
  ...
  const [formData, setFormData] = useState({
    ...
    paymentMethod: "doku", // doku | paypal
  });
  ...
  const amountToPay = formData.paymentType === "deposit" 
  ...
  return (
    <div className={styles.grid}>
      ...
      <div className={styles.paymentMethods}>
        ...
        <label className={styles.radioLabel}>
          ...
          <div className={styles.radioContent}>
            ...
            <span>Secure your booking now, pay the rest later. (${Math.round(totalPrice * 0.3)} USD)</span>
          </div>
        </label>
      </div>
      ...
      <div className={styles.formGroup}>
        ...
        />
        {!isAdmin && (
          <span className={styles.helpText}>To change email, sign out and log in again.</span>
        )}
      </div>
      ...
      <button type="submit" className={styles.submitBtn} disabled={loading}>
        {loading ? "Processing..." : `Proceed to Payment ($${amountToPay} USD)`}
      </button>
    </form>
    </div>
    ...
    <div className={styles.summaryCol}>
      <div className={styles.summaryCard}>
        ...
        <div className={styles.summaryItem}>
          ...
          <strong>{priceMode === "total_package" ? `Total Package (${totalDays} days)` : "Per Person"}</strong>
        </div>
        <div className={styles.summaryItem}>
